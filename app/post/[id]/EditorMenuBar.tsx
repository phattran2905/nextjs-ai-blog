		...
		<div className="flex justify-between items-center">
			<div className="flex items-center gap-4">
				<button
					...
					className={
						editor.isActive("heading", { level: 1 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"
					}
				>
				...
				<button
					...
					className={
						editor.isActive("heading", { level: 2 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"
					}
				>
				...
				<button
					...
					className={
						editor.isActive("heading", { level: 3 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"
					}
				>
